...
# shape); evict any stale cached entry -- schema.py imports config at module
# load time, so this must run before the schema import below.
...
class TestLoadSpecValid(unittest.TestCase):
    ...
    def test_face_detailer_overrides_parsed(self):
        ...
        data["comfyui"]["face_detailer"] = {"enabled": False, "denoise": 0.10, "guide_size": 768, "bbox_dilation": 150, "faceid_weight": 0.5}
